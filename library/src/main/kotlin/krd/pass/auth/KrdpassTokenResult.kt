...
data class KrdpassTokenResult(
    ...
    companion object {
         ...
         */
        fun fromMap(map: Map<String, Any?>): KrdpassTokenResult {
            return KrdpassTokenResult(
                ...
                receivedAt = (map["receivedAt"] as? Number ?: map["received_at"] as? Number)?.toLong() ?: System.currentTimeMillis()
            )
        }
    }
    /**
